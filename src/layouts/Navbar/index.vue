    ...
    <nav class="navbar w-full">
      <div class="flex flex-1 md:gap-1 lg:gap-2">
        ...
        >
          ...
          >
            <span class="text-accent">C<span class="lowercase">hatGPT</span></span>
            <span class="text-base-content">D<span class="lowercase">emo</span></span>
          </div>
        </RouterLink>
      </div>
      <div>
        ...
        >
          <span class="flex-none items-center">
            <a
              aria-label="Github"
              target="_blank"
              href="https://github.com/kirklin/chatgpt-demo"
